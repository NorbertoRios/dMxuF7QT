...
func TestBinaryReporPreParsing(t *testing.T) {
	...
	checkRawMessage("TestBinaryReporPreParsing", res, "34614709", messagetype.BinaryLocation, t)
}

func TestAckPreParsing(t *testing.T) {
	packet := []byte("000003912835 ACK <SETPARAM 133=59; ENDPARAM;BACKUPNVRAM;>")
	res := factory.BuildRawMessage(packet)
	checkRawMessage("TestAckPreParsing", res, "000003912835", messagetype.Ack, t)
}

func TestAckPreParsing2(t *testing.T) {
	packet := []byte("000003912835 ACK <SETPARAM 133=59; ENDPARAM;BACKUPNVRAM;>")
	res := factory.BuildRawMessage(packet)
	checkRawMessage("TestAckPreParsing2", res, "000003912835", messagetype.Ack, t)
}

func TestNackPreParsing(t *testing.T) {
	packet := []byte("000003912835 NAK- ERROR <ARAM BLA=dfgdfg; END>")
	res := factory.BuildRawMessage(packet)
	checkRawMessage("TestNackPreParsing", res, "000003912835", messagetype.Nack, t)
}
...
func TestAllParameters(t *testing.T) {
	...
	res := factory.BuildRawMessage(packet)
	checkRawMessage("TestAllParameters", res, "3912835", messagetype.Parameter, t)
}
...
func TestPoll(t *testing.T) {
	...
	res := factory.BuildRawMessage(packet)
	checkRawMessage("TestPoll", res, "3912835", messagetype.Poll, t)
}
...
func TestDiag1Wire(t *testing.T) {
	...
	res := factory.BuildRawMessage(packet)
	checkRawMessage("TestDiag1Wire", res, "3912835", messagetype.Diag1Wire, t)
}

func TestDiagParam(t *testing.T) {
	packet := []byte("PARAMETERS\n56=;\n000003912835 3912835\n")
	res := factory.BuildRawMessage(packet)
	checkRawMessage("TestDiagParam", res, "3912835", messagetype.Parameter, t)
}
...
func TestDiagCan(t *testing.T) {
	...
	res := factory.BuildRawMessage(packet)
	checkRawMessage("TestDiagCan", res, "3912835", messagetype.DiagCAN, t)
}
